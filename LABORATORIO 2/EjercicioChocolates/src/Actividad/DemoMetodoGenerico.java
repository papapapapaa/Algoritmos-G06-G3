...
public class DemoMetodoGenerico {
	...
	public static void main(String[] args) {
		...
		/*RPTA:
		Al descomenar las linea , el programa arrojara un error de copilacion.
		El metodo generico esta eperando que ambos arreglos ean del mismo tipo T pero 
		el ejemplo esta comparando un Integer con un Double.dandono un error de intento de comparacion.
